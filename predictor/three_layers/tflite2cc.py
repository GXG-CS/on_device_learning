...
# Convert model_part1.tflite to C array
# python tflite2cc.py model_part1.tflite model_part1.cc g_model

# Convert model_part2.tflite to C array
# python tflite2cc.py model_part2.tflite model_part2.cc g_model

# Convert model_part3.tflite to C array
# python tflite2cc.py model_part3.tflite model_part3.cc g_model