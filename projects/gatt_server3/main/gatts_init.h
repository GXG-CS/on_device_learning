...
//     uint16_t descr_uuid16;
//     uint16_t num_handle;
//     uint8_t adv_service_uuid128[32];
//     esp_ble_adv_data_t adv_data;
//     esp_ble_adv_data_t scan_rsp_data;
//     esp_ble_adv_params_t adv_params;
// } ble_gatts_service_config_t;

// typedef struct {
//     char device_name[ESP_BLE_ADV_NAME_LEN_MAX];  // Device name moved here
//     ble_gatts_service_config_t service_a;
//     ble_gatts_service_config_t service_b;
// } ble_gatts_config_t;
