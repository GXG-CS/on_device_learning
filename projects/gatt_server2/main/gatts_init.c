...
# include "gatts_init.h"

static uint8_t char1_str[] = {0x11,0x22,0x33};
static esp_gatt_char_prop_t a_property = 0;
static esp_gatt_char_prop_t b_property = 0;

prepare_type_env_t a_prepare_write_env = {0};
prepare_type_env_t b_prepare_write_env = {0};


// char test_device_name[ESP_BLE_ADV_NAME_LEN_MAX] = "ESP_GATTS_DEMO";
char test_device_name[TEST_DEVICE_NAME_MAX_LEN] = "ESP_GATTS_DEMO";
...
void gatts_init(void) {
    ...
    // Register GATT server callback to handle GATT events
    ...
    // Register GAP callback to handle advertising and connection parameters
    ...
    // Register application profile A
    ...
    // Register application profile B
    ...
    // Set the local MTU size for GATT operations
