                               ...
                               uint16_t unicast, uint8_t elem_num, uint16_t net_idx)
{
    ...
    err = send_node_capabilities_get(net_idx, prov_key.app_idx, node->unicast, &root_models[3]);
...
// {
//     uint16_t net_idx = 0x0000;
//     uint16_t app_idx = 0x0000;
//     uint16_t unicast_addr = 0x0001;
//     esp_ble_mesh_model_t model;
//     esp_ble_mesh_client_common_param_t common; // Declare common variable

//     esp_err_t err = example_ble_mesh_set_msg_common(&common, net_idx, app_idx, unicast_addr, OP_NODE_CAPABILITIES_GET, &model);
//     if (err != ESP_OK) {
//         ESP_LOGE(TAG, "Failed to set common message parameters");
//     }

//     err = send_node_capabilities_get(net_idx, app_idx, unicast_addr, &model);
//     if (err != ESP_OK) {
//         ESP_LOGE(TAG, "Failed to send node capabilities get message");
//     }
// }
...
//     // Initialize BLE Mesh and other components as needed
//     example_function();
// }
